...
function CreateBunker(props) {
  ...
  function handleEditRoom(index) {
    console.log(
      "Wanting to edit room " + index + " " + bunkerRooms[index].name
    );
    ...
    <>
      ...
      <div className="secondary-container-a">
        <div className="title-text">
          {getBunker ? "Edit Bunker" : "Create Bunker"}
        </div>
        <div className="secondary-container-d">
          <div className="buttons-left-row">
            <Button variant="contained" onClick={handleBunkerSave}>
              Save Bunker
            </Button>
            <Button variant="contained" onClick={handleBunkerInfoOpen}>
              Bunker Info
            </Button>
            <Button variant="contained" onClick={handleTestBunker}>
              Test Bunker
            </Button>
          </div>
        </div>
        ...
        >
          ...
          <FormControlLabel
            control={
              <Checkbox
                checked={newRoomFinalRoom}
                onChange={(e) => setNewRoomFinalRoom(e.target.checked)}
              />
            }
            label="Final Room"
          />
        ...
        {bunkerRooms.map((room, index) => (
          <Card sx={{ minWidth: 275 }} key={index}>
            <CardContent>
              ...
              <Button variant="contained" onClick={() => handleEditRoom(index)}>
                Edit Room
              </Button>
            </CardContent>
          </Card>
