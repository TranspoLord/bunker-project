...
function Home() {
  ...
  <div className="container">
    <div className="button-container">
      ...
      <Link to="/GPTTesting" className="button button-disabled">
        GPT Testing
      </Link>
    </div>
    ...
    <div className="text-container">
      ...
      <p>Currently, the UI is a bit lacking... a lot. I'm working on backend development first before prioritizing the UI.</p>
      <p>NOTE: The game is kind of playable, so expect a lot of missing features and/or bugs.</p>
      <p>If you look in the Dev Log, you can see a rough ToDo List of bugs, quality of life improvements, and planned updates!</p>
    </div>
  </div>
</>
  )
